...
NOISE_SCHEDULE=sqrt
BATCH_SIZE=128
CHECKPOINT_PATH="ckpts/${DSET}/trial_${SEQ_LEN}_${LR}_${DIFFUSION_STEPS}_${LR_ANNEAL_STEPS}_${WARMUP}_schegran${SCHEDULE_UPDATE}_src${SRC}_tgt${TGT}_0110"
TRAIN_TXT_PATH="./data/wiki/train"
VAL_TXT_PATH="./data/wiki/valid"
IN_CHANNELS=512
WEIGHT_DECAY=0.0
SEED=10708
DROPOUT=0.1
...
NOTES="wiki training with noise schedule and self condition"
