...
CHECKPOINT_PATH="ckpts/${DSET}/iwslt14_${SEQ_LEN}_${LR}_${DIFFUSION_STEPS}_${LR_ANNEAL_STEPS}_${WARMUP}_schegran${SCHEDULE_UPDATE_STRIDE}_src${SRC}_tgt${TGT}"
TRAIN_TXT_PATH="./data/iwslt14/train"
VAL_TXT_PATH="./data/iwslt14/valid"
IN_CHANNELS=512
WEIGHT_DECAY=0.0
SEED=10708
DROPOUT=0.3
...
NOTES="iwslt14 training with noise schedule and self condition"
