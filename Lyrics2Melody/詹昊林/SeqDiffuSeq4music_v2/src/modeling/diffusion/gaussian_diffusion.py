...
class GaussianDiffusion:
    ...
    def training_losses(self, model, training_step, t, model_kwargs=None, noise=None):
        ...
        try: x_start_mean = model.model.get_embeds(input_ids)
        except: x_start_mean = model.model.module.get_embeds(input_ids)
        ...
        try: get_logits = model.model.get_logits
        except: get_logits = model.model.module.get_logits
